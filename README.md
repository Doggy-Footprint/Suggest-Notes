...
# Posting
- ![한국어](https://harsh-wavelength-48b.notion.site/Obsidian-Plugin-Obisidian-Plugin-API-35010f228487427192f7dd88bfd95e15?source=copy_link)
- ![English](https://harsh-wavelength-48b.notion.site/Debugging-Obsidian-Plugin-Why-I-don-t-separate-business-logics-742979440a8d47a9808180a09a702d5d?source=copy_link)

I know this posting is obsolete now, but I wanna share how I dig into Obsidian Plugin API and debugging :) You'd better ask ai with Obsidian API url & downloaded library
이제는 별로 필요 없지만, 제가 옵시디언 플러그인 API를 어떻게 분석해내고, 디버깅 했는지 공유하고 싶었습니다. :) 지금은 AI에 Obsidian API url과 다운로드한 library를 전달하는 게 낫습니다.
